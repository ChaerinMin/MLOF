...
class RAFTGMA(nn.Module):
    def __init__(self, args):
        ...
        self.fnet = BasicEncoder(output_dim=256, norm_fn='instance', dropout=args.dropout,args=args)
        self.cnet = BasicEncoder(output_dim=hdim + cdim, norm_fn='batch', dropout=args.dropout,args=args)
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, upsample=True, test_mode=False):
        ...
        fmap1 = fmap1.float()
        fmap2 = fmap2.float()
        corr_fn = CorrBlock(fmap1, fmap2,self.args,radius=self.args.corr_radius)
