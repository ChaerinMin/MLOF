...
import math
from core.losses import transformer
...
class CorrBlock:
    def __init__(self, fmap1, fmap2, args=None,num_levels=4, radius=4):
    ...
    def __call__(self, coords): #
        ...
        for i in range(self.num_levels):
            ...
            corr = bilinear_sampler(corr, coords_lvl,args=self.args)  #(2232,1,36,62), (2232,9,9,2) out (2232,1,9,9)
...
class CorrBlockSingleScale(nn.Module):
    ...
    def __call__(self, coords):
        ...
        corr = bilinear_sampler(corr, coords_lvl,args=self.args)
